...
var drawGraph = function(graphicWidth) {
    ...
    var groupHeight = (BAR_WIDTH * numGroupBars) + (BAR_GAP_INNER * (numGroupBars - 1));
    var ticksX = 1;

    // define chart dimensions
    var width = (((((BAR_WIDTH + BAR_GAP_INNER) * numGroupBars) - BAR_GAP_INNER) + BAR_GAP) * numGroups) - BAR_GAP + BAR_GAP_INNER;
    var height = 300;
        ...
        .enter().append('rect')
            ...
            .attr('x', function(d, i) {
                if (i == 0) {
                    ...
                    return (BAR_WIDTH * i) + (BAR_GAP_INNER * i);
                }
            })
